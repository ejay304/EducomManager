...
namespace PrototypeEDUCOM.Model
{
    ...
    /// <summary>
    ///     Classe de type Model, représentant les données relatives aux contacts (clients, organisations/programmes 
    ///     et promo). Générée avec EntityFramework comme couche d'abstraction avec la base de données.
    /// </summary>
